...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_summa_ei_lataa_rahaa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_syo_edullisesti_voi_ostaa_kun_kortilla_vain_rahaa_edulliseen(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_maukkaasti()        
    ...
    def test_syo_maukkaasti_voi_ostaa_kun_kortilla_vain_rahaa_maukkaaseen(self):
